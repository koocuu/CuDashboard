...
- **2026-08-13**:顶栏改为「今日 / 项目 / 画像」；选题退出导航与首页主场，仅备查；作品墙为独立对象，MCP `get_projects` 可读；台账是季节性捕捉面，闲时不占主身份；作品墙不分在做/上线/暂停，用大字目录 + 焦点海报展示
...
- 可视化：大字目录定位 + 焦点海报 + 其余小海报；人和 MCP `get_projects` 读同一份
- 不自动生成画像；近况更新仍走提案策展
