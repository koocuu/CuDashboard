...
当前范围:**v2 Phase 1–3 已实现**；2026-08-13 信息架构改为 **今日 / 项目 / 画像**，2026-08-17 投资进入顶栏。选题降为备查。v1 的创作/情感/健身/感悟/决策/交易日志手动 UI 已按 v2 收敛移除。
...
- 今日:公开近况（与 /now 同源）、待确认、手头的事(忙时主位、闲时可不看)、备份告警；作品只在「项目」页，仓位只在「投资」页
